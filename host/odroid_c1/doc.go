...
// and C1+ boards. These boards use an Amlogic S805 processor (called "meson_8b"
// in the linux kernel). Currently no package for memory-mapped I/O has been written
// for this processor, thus all gpio functions are implemented via sysfs.
//
...
// Detection
//
// In order to detect the presence of ODROID-C0/C1/C1+ the following info coming from the
