...
var mappingA20 = map[string][5]pin.Func{
	...
	"PA14": {"ETXCK", "UART7_TX", "UART1_DTR", "GNULL", "I2S1_BCLK"},
	"PA15": {"ECRS", "UART7_RX", "UART1_DSR", "GTXCK", "I2S1_LRCK"},
	"PA16": {"ECOL", "CAN_TX", "UART1_DCD", "GCLKIN", "I2S1_DO"},
	"PA17": {"ETXERR", "CAN_RX", "UART1_RING", "GNULL", "I2S1_DI"},
	"PB0":  {"I2C0_SCK"},
	"PB1":  {"I2C0_SDA"},
	"PB2":  {"PWM0"},
