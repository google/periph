...
func (d *Dev) GetMeasurementModeRegister() (mm MeasurementModeParams, err error) {
	r := make([]byte, 1)
...
type SensorValues struct {
	...
	RawDataCurrent int // Current is in uA.
	RawDataVoltage int // Voltage from range 0-1023, where 1023 = 1.65V.
}
