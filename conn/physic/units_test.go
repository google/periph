...
func TestSpeed_Set(t *testing.T) {
	tests := []struct {
		...
		{"1000nfps", "1000nfps", 305 * NanoMetrePerSecond},
		{"-1000nfps", "-1000nfps", -305 * NanoMetrePerSecond},
		{"100nmph", "100nmph", 45 * NanoMetrePerSecond},
		{"-100nmph", "-100nmph", -45 * NanoMetrePerSecond},
		{"100km/h", "100km/h", 27777777778 * NanoMetrePerSecond}}
...
func TestMass_Set(t *testing.T) {
	tests := []struct {
		...
		{"1ounces", "1ounces", 1 * OunceMass},
		{"1oz", "1oz", 1 * OunceMass},
		{"1uoz", "1uoz", 28350 * NanoGram},
		{"-1uoz", "-1uoz", -28350 * NanoGram},
		{"1moz", "1moz", 28349523 * NanoGram},
		{"10moz", "10moz", 283495231 * NanoGram},
		{"100moz", "100moz", 2834952313 * NanoGram},
		{"1000moz", "1000moz", 1 * OunceMass},
		{"1Oz", "1Oz", 1 * OunceMass},
		{"1MOz", "1MOz", 1000000 * OunceMass},
		{"1lb", "1lb", 1 * PoundMass},
