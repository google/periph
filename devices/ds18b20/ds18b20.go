...
func (d *Dev) Temperature() (rwio.Celsius, error) {
...
func (d *Dev) LastTemp() (rwio.Celsius, error) {
	...
	// extension multiply by 1000 to get rwio.Millis, divide by 16 due to 4
	// fractional bits. Datasheet p.4.
	c := (rwio.Celsius(int8(spad[1]))<<8 + rwio.Celsius(spad[0])) * 1000 / 16
